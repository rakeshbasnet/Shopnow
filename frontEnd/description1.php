...
<script type="text/javascript">
   ...
   function valid(id){
    ...
    if(id == "esewa"){
      document.getElementById('pay').value="eSewa";
        esewabar();
    }
...
<div id="formcontent">
  <img src="close.png" width="25px" height="25px" style="float:right;" onclick="remove()"/>
    ...
    <input type="text" id="mobile" name="mobileNo" autocomplete="off" placeholder="Number you want to make contact" autofocus=""><br>
    ...
    <input type="text" name="address" id="address" autocomplete="off" placeholder="Address you want to receive"><br>
    <span style="margin-left:250px; color:red" id="add"></span>
    <input type="hidden" name="payMethod" id="pay">
    <?php
...
<div id="method">
  ...
  <button type="button" name="eSewa" onclick="valid(this.id)" id="esewa" class="paybtn"><img src="esewa.png" width="200px" height="150px"/></button>
  <img src="khalti.jpg" width="200px" height="150px" class="paybtn"/>
  <button type="button" name="cash" onclick="valid(this.id)" id="cash" class="paybtn"><img src="Cash.jpg" width="200px" height="150px"/></button>
  </center>
</div>
  </form>
</div>
